            ...
            <Fragment>
                ...
                <div className="about-container">
                    ...
                    <div className="bubbles">
                        <div>
                            <img className="floating img1" src="https://github.com/RyanPWalker/RyanPWalker/tree/master/src/assets/images/Handsome" alt="Me" />
                            <h3>Me</h3>
                        </div>
                        <div className="">
                            <img className="floating img2" src="https://github.com/RyanPWalker/RyanPWalker/tree/master/src/assets/images/Maddy" alt="My Wife Maddy" />
                            <h3>Maddy</h3>
                        </div>
                        <div className="">
                            <img className="floating img3" src="https://github.com/RyanPWalker/RyanPWalker/tree/master/src/assets/images/Cody" alt="My crazy dog Cody" />
                            <h3>Cody</h3>
                        </div>
                        <div className="">
                            <img className="floating img4" src="https://github.com/RyanPWalker/RyanPWalker/tree/master/src/assets/images/Willow" alt="My cuddly dog Willow" />
                            <h3>Willow</h3>
                        </div>
                    </div>
                    <p>
